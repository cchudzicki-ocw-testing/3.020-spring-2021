...
image_metadata:
  caption: 'Carbon dioxide only exists in a solid or gas state at atmospheric pressure:
    the images captures jets of liquid carbon dioxide as they hit atmospheric pressure
    and begin to change state to gas. (Image by [Lena RUB](https://commons.wikimedia.org/wiki/File:Liquid_carbon_dioxide_jets_02.png).
